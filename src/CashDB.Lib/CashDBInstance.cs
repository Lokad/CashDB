...
namespace CashDB.Lib
{
    public class CashDBInstance
    {
        ...
        /// </summary>
        public static void InitializeFiles(CashDBConfig config, long layer1Capacity, long layer2Capacity = 0,
            ILog log = null)
        {
            log?.Log(LogSeverity.Info, "Starting CashDB setup.");
            ...
            log?.Log(LogSeverity.Info, "CashDB file creation completed successfully.");
        }

        public CashDBInstance(ILog log = null)
        {
            _log = log;
        }

        public void SetupNetwork(CashDBConfig config)
        {
