...
namespace CashDB.Lib.Coins
{
    public ref struct Coin
    {
        ...
        private unsafe struct CoinHeader
        {
            ...
            public CashDBOutpointFlags Flags;
        ...
        public CashDBOutpointFlags Flags => AsHeader.Flags;
        ...
        public CashDBOutpointFlags OutpointFlags
        {
            get => AsHeader.Flags;
        ...
        public Coin(ref Outpoint outpoint, bool isCoinBase, Payload payload, CoinEvent evt, SpanPool<byte> pool)
        {
            ...
            OutpointFlags = isCoinBase ? CashDBOutpointFlags.PersistentIsCoinbase : CashDBOutpointFlags.None;
