...
{
    /// <summary>
    /// Opaque handle to a block of CashDB server (zero means 'undefined' though).
    /// </summary>
    /// <remarks>
    /// CashDB client communicates with CashDB server based on  this opaque struct.
    /// Inside CashDB server, it maps to a <see cref="BlockAlias"/>.
    /// </remarks>
