...
{
    public unsafe ref struct CloseConnectionResponse
    {
        ...
        public CloseConnectionResponse(Span<byte> buffer, RequestId requestId, ClientId clientId)
        {
            _buffer = buffer;
            ...
            AsHeader.RequestHeader.MessageKind = MessageKind.CloseConnectionResponse;
        }
