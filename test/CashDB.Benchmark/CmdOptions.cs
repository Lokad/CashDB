...
namespace CashDB.Benchmark
{
    ...
    [Verb("rrun", HelpText = "Run a benchmark against a remote CashDB instance.")]
    public class RRunOptions
    {
        [Option("ipAddress", Required = true, HelpText = "IP Address of the CashDB instance.")]
        public string IpAddress { get; set; }

        [Option("port", Required = false, HelpText = "Port of the CashDB instance.", Default = Constants.DefaultPort)]
