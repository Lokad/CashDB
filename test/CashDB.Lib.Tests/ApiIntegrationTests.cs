...
using CashDB.Lib.Messaging.Protocol;
using CashDB.Lib.Tests.Mock;
using Xunit;

namespace CashDB.Lib.Tests
{
    public class ApiIntegrationTests
    {
        ...
        [Fact]
        public void CashDB_utxo_get_committed_block()
        {
            CashDB_utxo_commit_block();
        ...
        [Fact]
        public void CashDB_uxto_get_blockinfo_uncommitted()
        {
            UncommittedBlockId blockUcid = CashDB_utxo_open_block();
        ...
        [Fact]
        public void CashDB_uxto_get_blockinfo_committed()
        {
            CashDB_utxo_commit_block();
        ...
        [Fact]
        public void CashDB_utxo_get()
        {
            // TODO: functionality not implemented yet
        }

        [Fact]
        public UncommittedBlockId CashDB_utxo_open_block()
        {
            Setup();
        ...
        [Fact]
        public void CashDB_utxo_write_txs()
        {
            // TODO: functionality not implemented yet
        }

        [Fact]
        public void CashDB_utxo_get_uncommitted_block()
        {
            var blockUcid = CashDB_utxo_open_block();
        ...
        [Fact]
        public void CashDB_utxo_commit_block()
        {
            CashDB_utxo_get_uncommitted_block();
