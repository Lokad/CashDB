...
using CashDB.Lib.Networking;
using CashDB.Lib.Tests.Mock;
using Xunit;
using Xunit.Abstractions;
using CommitBlockStatus = CashDB.Lib.Messaging.CommitBlockStatus;
using OpenBlockStatus = CashDB.Lib.Messaging.OpenBlockStatus;

namespace CashDB.Lib.Tests
{
    public class CashDBInstanceTests
    {
        private readonly ILog _log;

        public CashDBInstanceTests(ITestOutputHelper output)
        {
            _log = new XLog(output);
        }

        private CashDBInstance GetInstance()
        {
