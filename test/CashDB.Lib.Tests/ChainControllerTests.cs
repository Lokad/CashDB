...
using Xunit;
using CommitBlockStatus = CashDB.Lib.Chains.CommitBlockStatus;
using OpenBlockStatus = CashDB.Lib.Chains.OpenBlockStatus;
...
namespace CashDB.Lib.Tests
{
    public class ChainControllerTests
    {
        ...
        public (IChainStore, BoundedInbox, BoundedInbox, ChainController, ClientId, UncommittedBlockId) TestOpenBlock()
        {
            ...
            //var persister = new BlockchainPersister(CashDBConfiguration.CommittedBlocksPersistencePath,
            //    CashDBConfiguration.UncommittedBlocksPersistencePath);
