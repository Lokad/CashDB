...
using CashDB.Lib.Messaging.NativeClient;
using CashDB.Lib.Tests.Mock;
using Xunit;
using Xunit.Abstractions;
using Coin = CashDB.Lib.Messaging.NativeClient.Coin;

namespace CashDB.Lib.Tests.Messaging.NativeClient
{
    public class CashDBClientTests
    {
        private readonly ILog _log;

        public CashDBClientTests(ITestOutputHelper output)
        {
        ...
        public void Connect()
        {
            ...
            CashDBClient client = null;

            try
            {
                instance.Start();
                client = new CashDBClient($"127.0.0.1:{instance.Port}");
